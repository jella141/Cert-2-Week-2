...
var Player = function()
{
	...
	// walk right
	this.sprite.buildAnimation(12, 8, 165, 126, 0.05,
	[65,66,67,68,69,70,71,72,73,74,75,78,77,78]);
	// Shoot left
	this.sprite.buildAnimation(12, 8, 165, 126, 0.05,
...
Player.prototype.update = function(deltaTime)
{
	...
	else
	{
		if(!this.jumping && !this.falling)
		{
			...
			{
				if(this.sprite.currentAnimation != ANIM_IDLE_LEFT && !this.jumping)
	...
	if (keyboard.isKeyDown(keyboard.KEY_SHIFT))
		{
				...
				{
					if (left)
						this.bullets[this.cur_bullet_index].fire(this.x, this.y,-1, 0);
					else
						this.bullets[this.cur_bullet_index].fire(this.x, this.y, 1, 0);
...
{
	context.drawImage(this.heart_image, 40 + i * (this.heart_image.width),40);
}